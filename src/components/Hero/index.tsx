  ...
  return (
    <Container classNames="">
      <section className="py-16">
        <h1 className="h1">
          In Design We Trust<span className="ml-1 text-skin-primary">.</span>
        </h1>
        <p className="sm:text-lg lg:text-2xl max-w-screen-md">
          Our design system helps us work together to build a great experience
          for all of Fiskaly’s devs. These areas of design are the foundations
          on which the Fiskaly Brand is built. Our aim is to create consistent
          and delightful user experiences across all platforms.
        </p>
