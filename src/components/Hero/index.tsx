        ...
        <Container classNames="">
          <section className="py-16">
            ...
            <p className="sm:text-lg lg:text-2xl max-w-screen-md">
              Our design system <strong><em>Simply</em></strong> helps us work together to build a great
              experience for all of Fiskaly’s devs. These areas of design are
              the foundations on which the Fiskaly Brand is built. Our aim is to
              create consistent and delightful user experiences across all
              platforms.
            </p>
