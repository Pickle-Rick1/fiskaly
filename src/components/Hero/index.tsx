  ...
  return (
    <Container classNames="bg-gray-900 text-white">
      <section className="py-16">
        <a
          href="#/"
          className="inline-flex items-center bg-black rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base hover:text-gray-200"
        >
        ...
        <h1 className="h1">
          Design made simple<span className="text-brand">.</span>
        </h1>
